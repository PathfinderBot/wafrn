    ...
    children: [
      {
        ...
        loadComponent: () =>
          import("./components/home-redirector/home-redirector.component").then(
            (m) => m.HomeRedirectorComponent
          ),
        //loadChildren: () =>
      },
      ...
      },
      {
        path: "login/mfa",
        loadChildren: () =>
          import("./pages/login-mfa/login-mfa.module").then(
            (m) => m.LoginMfaModule
          ),
      },
      {
      ...
      },
      {
        ...
        canActivate: [loginRequiredGuard],
        loadComponent: () =>
          import("./components/new-editor/new-editor.component").then(
            (m) => m.NewEditorComponent
          ),
      },
      {
        path: "aac4alex",
        loadComponent: () =>
          import("./pages/aac-for-alex/aac-for-alex.component").then(
            (m) => m.AacForAlexComponent
          ),
      },
      {
