...
// from https://www.loc.gov/standards/iso639-2/langhome.html
...
const LANGUAGES: Language[] = [
  ...
  { code3: 'bih', code2: '', name: "Bihari languages" },
  ...
  { code3: 'chu', code2: 'cu', name: "Church Slavic; Old Slavonic; Church Slavonic; Old Bulgarian; Old Church Slavonic" },
  ...
  { code3: 'dgr', code2: '', name: "Tlicho; Dogrib" },
  ...
  { code3: 'ell', code2: 'el', name: "Modern Greek (1453-)" },
  ...
  { code3: 'gre', code2: 'el', name: "Modern Greek (1453-)" },
  ...
  { code3: 'him', code2: '', name: "Himachali languages; Western Pahari languages" },
  ...
  { code3: 'ina', code2: 'ia', name: "Interlingua (International Auxiliary Language Association)" },
  ...
  { code3: 'nds', code2: '', name: "Low German; Low Saxon; German, Low; Saxon, Low" },
  { code3: 'nep', code2: 'ne', name: "Nepali" },
  { code3: 'new', code2: '', name: "Nepal Bhasa; Newar; Newari" },
  ...
  { code3: 'nwc', code2: '', name: "Classical Newari; Old Newari; Classical Nepal Bhasa" },
  ...
  { code3: 'pro', code2: '', name: "Provençal, Old (to 1500); Occitan, Old (to 1500)" },
  { code3: 'pus', code2: 'ps', name: "Pushto; Pashto" },
  // { code3: 'qaa-qtz', code2: '', name: "Reserved for local use" }, what
...
/** 
  Checks if a text is a valid ISO 639-2 language code.
  Removes extended subtags if they're present.
*/
export function filterLanguageCode(text: any): string | undefined {
  ...
  const thirdChar = text.at(2);
  let code = '';

  if (thirdChar == "-" || thirdChar == "_") {
    code = text.substring(0, 2).toLowerCase();
  } else {
