...
export const up: Migration = async (params) => {
  ...
  await queryInterface.sequelize.query(`CREATE INDEX IF NOT EXISTS bites_biter  ON "bites" ("biterId")`)
  await queryInterface.sequelize.query(`CREATE INDEX IF NOT EXISTS bites_bited  ON "bites" ("bittenId")`)
